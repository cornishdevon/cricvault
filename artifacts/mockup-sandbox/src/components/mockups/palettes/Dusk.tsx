export function Dusk() {
  const p = {
    bg: "#F0EEF8", card: "#FAF9FF", primary: "#4C3D8F", primaryFg: "#fff",
    fg: "#1A1530", muted: "#DDD8F0", mutedFg: "#6A6080", border: "#C8C2DC",
    accent: "#E67E22", pavilion: "#2C2057", pavilionFg: "#F0EEFF",
    pavilionMuted: "rgba(255,255,255,0.55)",
  };
  return <PalettePreview p={p} name="Dusk" />;
}
