...
function computeBadges(data: PerMatchStat[]): Badge[] {
  ...
  const first50  = battingInnings.find((d) => (d.runs ?? 0) >= 50);
  ...
  const badges: Badge[] = [
    ...
    // Batting milestones
    { id: "first50",       label: "Half-Century",    description: "50+ runs in an innings",            icon: "🏏", earned: !!first50, detail: first50 ? `${first50.runs} vs ${first50.opponent}` : undefined },
